...
const STEPS = [
  ...
  { num: '2', text: 'Відкрий Minecraft → «Параметри» → «Пакети ресурсів»' },
  { num: '3', text: 'Натисни «Відкрити теку з пакетами» у нижньому лівому куті' },
  { num: '4', text: 'Перемісти завантажений zip-файл у відкриту папку' },
  { num: '5', text: 'Повернись до Minecraft та активуй пак зі списку' },
];
